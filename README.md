...
- `data/` — the original Excel workbook (public DDOT crash and camera data).
...
```
DCTrafficCamerasandCrashes/
├── data/                          the original dataset (Midterm Memo)
├── scripts/                       the 4-step pipeline
...
| 04 build workbook | `outputs/camera_analysis_results.xlsx` |
